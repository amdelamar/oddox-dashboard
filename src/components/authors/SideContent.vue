<template>
  <div class="full-height">
    ...
    <div id="list" class="background-solid-white border-left border-right full-height scrollable text-left animated fadeIn">
      ...
      <p class="padding-top text-center" v-if="authors === null || authors.length < 1">
        <em>No authors found.</em>
      </p>

      <a class="overflow-none" :href="'/#/author/' + author._id" v-for="author in authors">
        <div class="row padding border-bottom margin-none hover-background-solid-grey" v-bind:class="{ 'active': currentAuthor !== null && author._id === currentAuthor._id }">
